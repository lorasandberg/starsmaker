...
public:
	inline Particle_t250075699  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Particle_t250075699 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
